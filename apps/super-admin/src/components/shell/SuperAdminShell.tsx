...
const navGroups = [
  {
    title: 'ОБЗОР',
    items: [{ href: '/', icon: LayoutDashboard, label: 'MRR и метрики' }],
  },
  {
    title: 'КЛИЕНТЫ',
    items: [
      { href: '/tenants', icon: Building2, label: 'Все организации' },
      { href: '/onboarding', icon: UserPlus, label: 'После оплаты' },
    ],
  },
  {
    title: 'ПОДДЕРЖКА',
    items: [{ href: '/support', icon: Headphones, label: 'Чаты и тикеты' }],
  },
  {
    title: 'ПЛАТФОРМА',
    items: [
      { href: '/ai', icon: Brain, label: 'ИИ и промпты' },
