...
export function SupportChat() {
  ...
  return (
    <CrmPage width="std" className="flex flex-col min-h-0 overflow-x-hidden overflow-y-hidden">
      <div className="flex-1 min-h-0 min-w-0 flex flex-col w-full max-w-3xl mx-auto">
      {chatBlocked ? (
